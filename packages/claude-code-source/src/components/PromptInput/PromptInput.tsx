...
function PromptInput({
  ...
  const _companion = isBuddyEnabled() ? getCompanion() : undefined;
  const companionMuted = isBuddyEnabled() ? getGlobalConfig().companionMuted : undefined;
  ...
  const companionSpeaking = useAppState(s => isBuddyEnabled() && s.companionReaction !== undefined);
  const {
    columns,
    rows
  } = useTerminalSize();
