...
import { isComputerUseEnabled } from '../../utils/sourceFeatures.js'
...
/**
 * Source checkout defaults built-in MCP servers to enabled so local dev
 * sessions behave like a fully wired product build.
 */
