...
Auto-switch model by task complexity: `routing: { enabled: true, l0: "...", l1: "...", l2: "..." }`. [→ Full docs](/en/README)
...
[→ Full roadmap](/en/roadmap) · [→ P0 Plan](/en/P0-IMPROVEMENT-PLAN) · [→ P1 Plan](/en/P1-IMPLEMENTATION-PLAN)
