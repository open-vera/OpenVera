        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Compression", link: "/core/compression-design" },
              { text: "Subagent System", link: "/core/subagent-design" },
              { text: "Tools Overview", link: "/core/tools-overview" },
              ...
              { text: "Session Design", link: "/core/session-design" },
          ...
          },
          {
            ...
            items: [
              ...
              { text: "RAG System", link: "/platform/rag" },
              ...
              { text: "Channel Adapters", link: "/platform/channel" },
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Test Coverage", link: "/eval/test-coverage" },
        ...
        sidebar: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: "压缩机制", link: "/zh/core/compression-design" },
              { text: "Subagent 系统", link: "/zh/core/subagent-design" },
              { text: "工具总览", link: "/zh/core/tools-overview" },
              { text: "工具运行时", link: "/zh/core/tool-runtime" },
              { text: "工具渲染", link: "/zh/core/tool-rendering" },
              { text: "Skill 集成", link: "/zh/core/skill-tool-integration" },
              { text: "Skill 编写", link: "/zh/core/skill-authoring-guide" },
              { text: "Session 设计", link: "/zh/core/session-design" },
              { text: "Session 机制", link: "/zh/core/claude-code-session-mechanism" },
              { text: "能力差距", link: "/zh/core/capability-gaps" },
              { text: "P0 对齐", link: "/zh/core/p0-alignment-checklist" },
            ],
          },
          {
            text: "⚙️ Harness — 执行内核",
          ...
          },
          {
            ...
            items: [
              ...
              { text: "RAG 系统", link: "/zh/platform/rag" },
              { text: "Sandbox", link: "/zh/platform/sandbox" },
          ...
          },
          {
            ...
            items: [
              ...
              { text: "测试覆盖率", link: "/zh/eval/test-coverage" },
